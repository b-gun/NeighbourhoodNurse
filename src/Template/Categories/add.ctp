...
<div class="categories form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            echo $this->Form->input('icd10', ['class' => 'form-control', 'style' => 'width:30%;']);
            echo $this->Form->input('category', ['class' => 'form-control', 'style' => 'width:30%;']);
            echo $this->Form->input('comment', ['class' => 'form-control', 'style' => 'width:30%;']);
        ?>
    </fieldset>
      <?php
